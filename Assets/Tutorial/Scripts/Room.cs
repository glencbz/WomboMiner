...
public class Room
{
	...
	private IntRange roomIDs = new IntRange(0,10);
	...
	public void SetupRoom (IntRange widthRange, IntRange heightRange, int columns, int rows)
	{
		...
		xPos = roomIDs.Random*20;
		yPos = roomIDs.Random*20;
	}
	...
	public void SetupRoom (IntRange widthRange, IntRange heightRange, int columns, int rows, Room room)
	{
		//Add adjacent room
		// if already occupied, generate again
	}
}